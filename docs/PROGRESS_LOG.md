...
- User authorised the two remaining gimbal fixes. Starting from `fa363e5680e577784194b3f023f114eecf16e055`, added selected-autopilot ATTITUDE/ATTITUDE_QUATERNION ingestion and full horizon/heading-to-BODY_FRD composition. Kept fixed mode independent and retained the configured body-down envelope.
...
- Next: independent code review and current GitHub checks, followed by the recorded integration gates. No aircraft parameters, applet behaviour or deployment was changed.
