...
Last reviewed: 2026-09-14. This is the planned acceptance suite for the new work. Existing unit/browser/container evidence is recorded separately in [PROJECT_STATUS.md](PROJECT_STATUS.md). **No complete scenario below is claimed accepted.** Partial software checks and remaining acceptance work are recorded in the progress register.
...
| T02 | Multi-tag board, single-tag visibility, outliers, scale and planar ambiguity; valid mixed-size planar observations | Correct common origin and declared error bounds; bad fits/scale mismatches diagnosed; valid complete observations must not be lost in the outlier prefilter; no jump to whichever tag is visible. | Automated + measured bench / B01, F05; [LMBOOT-001](LANDMARK_REFERENCE_REVIEW.md#synthetic-pose-rejection) provides a self-contained public reproduction with nine rejected noiseless cases out of eighteen depth/seed combinations on main `ab2f242790d324ef030602f0aa2a5bcbf940f8c5` with OpenCV 4.13.0. B01 reopened; correction and deployment-environment regressions pending. |
...
| T06 | Tilt/yaw aircraft while gimbal stabilises; yaw follow/lock and alternate flag conventions | Compose time-aligned aircraft attitude with horizon/heading-referenced gimbal attitude to produce correct BODY_FRD vectors; reconstructed ground target remains fixed. Include nonzero aircraft roll/pitch, axis swaps, boresight, quaternion sign and singular attitudes. | Automated + bench/HIL / G01–G03; software regressions pass locally, in PR-head CI 34830596708 and post-merge CI 34841164832 at `4819cebf823f573c738f343304556fa85ffdb88d`; bench/HIL remains unperformed |
| T07 | Delayed, out-of-order or lost attitude; mismatched clocks, nonadvancing device timestamps despite fresh packet arrival, device reboot/wrap, wrong device, unhealthy gimbal, stream freeze | Invalid observations rejected; per-device freshness expires without cached/reordered samples refreshing readiness. Reboot/wrap handling must follow an explicit reviewed policy. No fixed-mode fallback; residual undetectable video/estimator freeze documented. | Failure injection + bench / G01–G05; software regressions pass locally, in PR-head CI 34830596708 and post-merge CI 34841164832 at `4819cebf823f573c738f343304556fa85ffdb88d`; device bench/clock calibration remains unperformed |
...
| T16 | Landmark comparison, when supplied | Fair configuration/scale/timing comparison; differences reproduced against known geometry; unsupported conclusions clearly excluded. | Replay + available bench evidence / REF01; [LMBOOT-001](LANDMARK_REFERENCE_REVIEW.md) completes a limited boot-data/loader review and synthetic Wingxtra diagnostic. No Landmark application/source, recorded-image replay or measured comparison is available; T16 remains unaccepted. |
