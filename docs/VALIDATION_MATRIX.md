...
Last reviewed: 2026-09-14. This is the planned acceptance suite for the new work. Existing unit/browser/container evidence is recorded separately in [PROJECT_STATUS.md](PROJECT_STATUS.md). **No complete scenario below is claimed accepted.** Partial software checks and outstanding failures are recorded in the progress register.
