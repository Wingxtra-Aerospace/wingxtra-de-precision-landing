...
LABEL version="1.0.0-rc.2" \
      ...
      authors='[{"name":"Wingxtra Aerospace Ltd.","email":"hello@wingxtra.com"}]' \
      company='{"name":"Wingxtra Aerospace Ltd.","about":"Multi-tag precision landing","email":"hello@wingxtra.com"}' \
