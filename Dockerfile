...
LABEL version="1.0.0-rc.1" \
      ...
      authors='[{"name":"Wingxtra Aerospace"}]' \
      company='{"name":"Wingxtra Aerospace","about":"Multi-tag precision landing"}' \
      readme="https://raw.githubusercontent.com/Wingxtra-Aerospace/wingxtra-de-precision-landing/codex/blueos-precision-landing/README.md" \
