...
class DatabusParseTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        from wingxtra_pl.legacy_cli import _parse_port, _parse_host, resolve_databus_endpoint

        cls.parse_port = staticmethod(_parse_port)
        cls.parse_host = staticmethod(_parse_host)
        cls.resolve_databus_endpoint = staticmethod(resolve_databus_endpoint)
